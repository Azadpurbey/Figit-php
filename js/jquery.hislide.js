(function($) {
    ...
    var slide = function(ele,options) {
        ...
        // ];
        var states = [
            { $zIndex: 1, $transform: 'scale(0.7)', $top: 15, $left: 134, $opacity: 0.9 },
            { $zIndex: 2, $transform: 'scale(0.8)', $top: 10, $left: 0, $opacity: 0.9 },
            { $zIndex: 3, $transform: 'scale(0.9)', $top: 5, $left: 110, $opacity: 0.9 },
            { $zIndex: 4, $transform: 'scale(1)', $top: 0, $left: 263, $opacity: 1 },
            { $zIndex: 3, $transform: 'scale(0.9)', $top: 5, $left: 470, $opacity: 0.9 },
            { $zIndex: 2, $transform: 'scale(0.8)', $top: 10, $left: 620, $opacity: 0.9 },
            { $zIndex: 1, $transform: 'scale(0.7)', $top: 15, $left: 500, $opacity: 0.9 }
        ];
